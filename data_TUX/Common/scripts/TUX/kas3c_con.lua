...
DEF = 2
 ...
 function ScriptPostLoad()
	...
	--this disables the specified class from capturing a CP
        --CapturePosts = 0
    SetClassProperty("wok_inf_warrior", "CapturePosts", 0)
	SetClassProperty("wok_inf_warrior", "PointsToUnlock", "16")
