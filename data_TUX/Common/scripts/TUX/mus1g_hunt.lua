...
DEF = 2;
 ...
 --              it is called from C to start the missioan.
 ---------------------------------------------------------------------------
...
SetupTeams{
    all = {
        ...
        units = 16,
        reinforcements = 150,
        soldier = { "mus_inf_soldier",7, 25},
        assault = { "mus_inf_brute",1, 8},
        engineer = { "mus_inf_engineer", 1, 8},		
		officer = { "mus_inf_officer", 1, 6},
...
SetupTeams{
    ...
    AudioStreamAppendSegments("sound\\global.lvl",  "imp_unit_vo_quick", voiceQuick)     
     ...
     SetAmbientMusic(ALL, 1.0, "imp_mus_amb_start",  0,1)
     SetAmbientMusic(ALL, 0.8, "imp_mus_amb_middle", 1,1)
     SetAmbientMusic(ALL, 0.2,"imp_mus_amb_end",    2,1)
     ...
     SetVictoryMusic(ALL, "imp_mus_amb_victory")
     SetDefeatMusic (ALL, "imp_mus_amb_defeat")
