...
--Setting up Heros--
  ...
  SetMemoryPoolSize("OrdnanceTowCable", 40) -- !!!! need +4 extra for wrapped/fallen cables !!!!
    ...
    -- SetLowReinforcementsVoiceOver(CIS, IMP, "cis_hot_transport_away", .75, 1)
    -- SetLowReinforcementsVoiceOver(CIS, IMP, "cis_hot_transport_away", .5, 1)
    -- SetLowReinforcementsVoiceOver(CIS, IMP, "cis_hot_transport_away", .25, 1)
    ...
    SetAmbientMusic(CIS, 1.0, "cis_hot_amb_middle",  0,1)
    -- SetAmbientMusic(CIS, 0.9, "cis_hot_amb_middle", 1,1)
    -- SetAmbientMusic(CIS, 0.1, "cis_hot_amb_end",    2,1)
    SetAmbientMusic(IMP, 1.0, "rep_hot_amb_middle",  0,1)
    ...
    SetVictoryMusic(IMP, "rep_hot_amb_victory")
    SetDefeatMusic (IMP, "rep_hot_amb_defeat")
