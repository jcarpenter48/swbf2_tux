...
SetupTeams{
	...
	--SetTeamIcon(CIS, "rep_icon", "rep_icon", "rep_icon")
	--SetTeamName(CIS, "locals")
    --SetHeroClass(CIS, "all_inf_officer")
    ...
    SetBleedingVoiceOver(CIS, IMP, "rep_off_com_report_enemy_losing", 1)
    ...
    SetLowReinforcementsVoiceOver(CIS, IMP, "rep_off_defeat_im", .1, 1)
    SetLowReinforcementsVoiceOver(CIS, CIS, "rep_off_victory_im", .1, 1)    
    ...
    SetOutOfBoundsVoiceOver(CIS, "repleaving")
