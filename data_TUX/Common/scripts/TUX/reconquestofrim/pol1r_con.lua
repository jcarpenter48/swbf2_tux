...
function PlayAnimLock01Close()
 ...
 function ScriptInit()
    ...
    SetMemoryPoolSize ("Combo::State",400)      -- should be ~12x #Combo
    SetMemoryPoolSize ("Combo::Transition",400) -- should be a bit bigger than #Combo::State
    SetMemoryPoolSize ("Combo::Condition",400)  -- should be a bit bigger than #Combo::State
	...
	SetHeroClass(CIS, "rep_hero_obiwan")
