...
function ScriptPostLoad()
	...
	SetClassProperty("jed_knight_02", "PointsToUnlock", 12)
	SetClassProperty("jed_master_02", "PointsToUnlock", 0)	
	SetClassProperty("jed_knight_03", "PointsToUnlock", 12)
	
	--engineer
	SetClassProperty("all_inf_engineer_fleet", "GeometryName", "gar_inf_jediguard")
	SetClassProperty("all_inf_engineer_fleet", "GeometryLowRes", "gar_inf_jediguard_low1")
	--sniper
	SetClassProperty("all_inf_sniper_fleet", "GeometryName", "gar_inf_jediguard")
	SetClassProperty("all_inf_sniper_fleet", "GeometryLowRes", "gar_inf_jediguard_low1")
	--fixes
	SetClassProperty("gar_inf_temple_soldier", "WeaponName1", "all_weap_inf_rifle")
	SetClassProperty("gar_inf_temple_soldier", "WeaponName2", "all_weap_inf_thermaldetonator")
	SetClassProperty("gar_inf_temple_soldier", "WeaponName3", "all_weap_award_rifle")
	SetClassProperty("gar_inf_temple_soldier", "WeaponAmmo3", 6)
	SetClassProperty("gar_inf_temple_vanguard", "WeaponName1", "all_weap_inf_rocket_launcher")
	SetClassProperty("gar_inf_temple_vanguard", "WeaponName2", "all_weap_inf_pistol")
	SetClassProperty("gar_inf_temple_vanguard", "WeaponName3", "all_weap_award_pistol")
	SetClassProperty("gar_inf_temple_vanguard", "WeaponAmmo3", 6)
	SetClassProperty("gar_inf_temple_vanguard", "WeaponName4", "all_weap_award_rocket_launcher")
	SetClassProperty("gar_inf_temple_vanguard", "WeaponAmmo4", 5)
	SetClassProperty("gar_inf_temple_soldier", "FoleyFXClass", "all_inf_soldier")
	SetClassProperty("gar_inf_temple_vanguard", "FoleyFXClass", "all_inf_soldier")
...
--hero
	...
	SetClassProperty("jed_master_02", "FoleyFXClass", "all_inf_soldier")
...
function ScriptInit()
    ...
    SetMemoryPoolSize ("Combo",48)              -- should be ~ 2x number of jedi classes
    SetMemoryPoolSize ("Combo::State",550)      -- should be ~12x #Combo
    SetMemoryPoolSize ("Combo::Transition",550) -- should be a bit bigger than #Combo::State
    SetMemoryPoolSize ("Combo::Condition",550)  -- should be a bit bigger than #Combo::State
    SetMemoryPoolSize ("Combo::Attack",550)     -- should be ~8-12x #Combo
    SetMemoryPoolSize ("Combo::DamageSample",7000)  -- should be ~8-12x #Combo::Attack
    SetMemoryPoolSize ("Combo::Deflect",84)     -- should be ~1x #combo
   ...
   -- set up teams
    SetupTeams{
        ...
        cis = {
            ...
            soldier  = { "gar_inf_temple_soldier",9, 12},
            assault  = { "gar_inf_temple_vanguard",3, 6},
            engineer = { "all_inf_engineer_fleet",1, 6},
            sniper   = { "all_inf_sniper_fleet",1, 6},
            officer = {"jed_knight_02",1, 2},
			special = {"jed_knight_03",1, 2},
        }
    }
	 --AddUnitClass(CIS, "jed_knight_01",1,2)
	 --AddUnitClass(CIS, "jed_knight_02",0,2)
	 --AddUnitClass(CIS, "jed_knight_03",0,2)
	 --AddUnitClass(CIS, "jed_knight_04",1,2)
	 --AddUnitClass(CIS, "jed_runner",0,2)
	 --AddUnitClass(CIS, "jed_master_02",0,2)	
	 --SetTeamName(CIS, "jedi")
 ...
 AddDeathRegion("DeathRegion1")
    ...
    SetAmbientMusic(CIS, 1.0, "all_cor_amb_start",  0,1)
    SetAmbientMusic(CIS, 0.8, "all_cor_amb_middle", 1,1)
    SetAmbientMusic(CIS, 0.2, "all_cor_amb_end",    2,1)
    ...
    SetVictoryMusic(CIS, "all_cor_amb_victory")
    SetDefeatMusic (CIS, "all_cor_amb_defeat")
