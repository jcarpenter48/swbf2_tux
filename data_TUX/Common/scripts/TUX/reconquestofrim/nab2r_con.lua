...
function ScriptInit()
	...
	ReadDataFile("SIDE\\gian.lvl", "cis_hover_aat")
...
--    }
    ...
    SetHeroClass(CIS, "gar_inf_naboo_queen")
...
--    SetTeamAsFriend(DEF, GAR)
    ...
    --  Level Stats
    ClearWalkers()
    --AddWalkerType(0, 4) -- 4 droidekas with 0 leg pairs each
    local weaponCnt = 168
    ...
    SetAmbientMusic(CIS, 1.0, "all_nab_amb_start",  0,1)
    SetAmbientMusic(CIS, 0.8, "all_nab_amb_middle", 1,1)
    SetAmbientMusic(CIS, 0.2,"all_nab_amb_end",    2,1)
    ...
    SetVictoryMusic(CIS, "all_nab_amb_victory")
    SetDefeatMusic (CIS, "all_nab_amb_defeat")
