...
function ScriptPostLoad()
	...
	hunt = ObjectiveTDM:New{teamATT = 1, teamDEF = 2, multiplayerScoreLimit = 100,
						pointsPerKillATT = 3, pointsPerKillDEF = 1,
						textATT = "game.modes.hunt",
						textDEF = "game.modes.hunt2", hideCPs = true, multiplayerRules = true, isCelebrityDeathmatch = true}	
	hunt:Start()
	...
	SetClassProperty("jed_master_01", "PointsToUnlock", 8)
	SetClassProperty("jed_master_02", "PointsToUnlock", 8)	
	SetClassProperty("jed_master_03", "PointsToUnlock", 8)
	SetClassProperty("rep_inf_ep3_officer", "PointsToUnlock", 8)
	SetClassProperty("rep_inf_ep3_jettrooper", "PointsToUnlock", 6)
 end
...
function ScriptInit()
    ...
    SetupTeams{
        ...
        cis = {
            ...
            sniper   = { "jed_runner",1, 3},
            officer = {"jed_master_01",1, 3},
			special = {"jed_master_03",1, 3},
        }
     }
	 AddUnitClass(2, "jed_knight_01",1,3)
	 AddUnitClass(2, "jed_knight_02",1,3)
	 --AddUnitClass(2, "jed_knight_03",1,4)
	 AddUnitClass(2, "jed_knight_04",1,3)
	 --AddUnitClass(2, "jed_master_01",1,4)
	 AddUnitClass(2, "jed_master_02",1,3)
	 --AddUnitClass(2, "jed_master_03",1,4)
	 --AddUnitClass(2, "jed_runner",1,4)
