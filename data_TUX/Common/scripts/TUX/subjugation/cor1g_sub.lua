...
function ScriptInit()
   ...
   -- set up teams
    SetupTeams{
	 ...
	 AddUnitClass(ALL, "jed_knight_02",0,2)
	 AddUnitClass(ALL, "jed_knight_03",0,2)
	 AddUnitClass(ALL, "jed_knight_04",1,2)
	 --AddUnitClass(ALL, "jed_runner",0,2)
	 --AddUnitClass(ALL, "jed_master_02",0,2)	
	 SetTeamName(ALL, "jedi")
