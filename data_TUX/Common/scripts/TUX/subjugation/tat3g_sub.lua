...
--[[replace classes with gamorreans
	--sniper
	SetClassProperty("all_inf_sniper_fleet", "forcemode", 1)
	SetClassProperty("all_inf_sniper_fleet", "GeometryName", "gam_inf_gamorreanguard")
	SetClassProperty("all_inf_sniper_fleet", "GeometryLowRes", "gam_inf_gamorreanguard_low1")
	--SetClassProperty("all_inf_sniper_fleet", "SkeletonName", "gam")
	--SetClassProperty("all_inf_sniper_fleet", "SkeletonLowRes", "gamlz")
	--SetClassProperty("all_inf_sniper_fleet", "MaxHealth", 750.0)
	SetClassProperty("all_inf_sniper_fleet", "VOSound", " ")
	SetClassProperty("all_inf_sniper_fleet", "HurtSound", "gam_hurt")
	SetClassProperty("all_inf_sniper_fleet", "DeathSound", "gam_die")
	SetClassProperty("all_inf_sniper_fleet", "HidingSound", "gam_chatter")
	SetClassProperty("all_inf_sniper_fleet", "ApproachingTargetSound", "gam_chatter")
	SetClassProperty("all_inf_sniper_fleet", "FleeSound", "gam_chatter")
	SetClassProperty("all_inf_sniper_fleet", "PreparingForDamageSound", "gam_hurt")
	SetClassProperty("all_inf_sniper_fleet", "HeardEnemySound", "gam_chatter")
	--rocketeer
	SetClassProperty("all_inf_rocketeer_fleet", "forcemode", 1)
	SetClassProperty("all_inf_rocketeer_fleet", "GeometryName", "gam_inf_gamorreanguard")
	SetClassProperty("all_inf_rocketeer_fleet", "GeometryLowRes", "gam_inf_gamorreanguard_low1")
	SetClassProperty("all_inf_rocketeer_fleet", "SkeletonName", "gam")
	SetClassProperty("all_inf_rocketeer_fleet", "SkeletonLowRes", "gamlz")
	--SetClassProperty("all_inf_rocketeer_fleet", "MaxHealth", 750.0)
	--SetClassProperty("all_inf_rocketeer_fleet", "VOSound", " ")
	SetClassProperty("all_inf_rocketeer_fleet", "HurtSound", "gam_hurt")
	SetClassProperty("all_inf_rocketeer_fleet", "DeathSound", "gam_die")
	SetClassProperty("all_inf_rocketeer_fleet", "HidingSound", "gam_chatter")
	SetClassProperty("all_inf_rocketeer_fleet", "ApproachingTargetSound", "gam_chatter")
	SetClassProperty("all_inf_rocketeer_fleet", "FleeSound", "gam_chatter")
	SetClassProperty("all_inf_rocketeer_fleet", "PreparingForDamageSound", "gam_hurt")
	SetClassProperty("all_inf_rocketeer_fleet", "HeardEnemySound", "gam_chatter")
--end class fixes]]--
...
function ScriptInit()
	...
	SetupTeams{
		all = {
			...
			--special	= { "gam_inf_gamorreanguard",1,4},
