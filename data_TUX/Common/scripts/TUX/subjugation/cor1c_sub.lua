...
function ScriptPostLoad()
	...
	SetClassProperty("all_inf_engineer_fleet", "WeaponName2", "rep_weap_inf_fusioncutter")
	SetClassProperty("all_inf_engineer_fleet", "WeaponName3", "rep_weap_inf_detpack")
	SetClassProperty("all_inf_engineer_fleet", "WeaponName4", "rep_weap_inf_powerup_dispenser")
...
function ScriptInit()
    ...
    SetupTeams{
	 ...
	 AddUnitClass(2, "jed_knight_01",1,2)
	 AddUnitClass(2, "jed_knight_02",0,2)
	 AddUnitClass(2, "jed_knight_03",0,2)
	 AddUnitClass(2, "jed_knight_04",1,2)
	 AddUnitClass(2, "jed_runner",0,2)
	 AddUnitClass(2, "jed_master_02",0,2)	

    SetTeamName(CIS, "jedi")
	SetTeamIcon(CIS, "all_icon")
     SetHeroClass(CIS, "rep_hero_macewindu")
