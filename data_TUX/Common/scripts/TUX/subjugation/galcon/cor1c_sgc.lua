...
function ScriptPostLoad()
	...
	SetClassProperty("all_inf_engineer_fleet", "WeaponName1", "cis_weap_inf_shotgun")
	SetClassProperty("all_inf_engineer_fleet", "WeaponName2", "cis_weap_inf_fusioncutter")
	...
	SetClassProperty("all_inf_engineer_fleet", "WeaponName5", "cis_weap_award_shotgun")
	SetClassProperty("all_inf_engineer_fleet", "FoleyFXClass", "rep_inf_soldier")
	--sniper
	...
	SetClassProperty("all_inf_sniper_fleet", "WeaponName1", "rep_weap_inf_sniper_rifle")
	SetClassProperty("all_inf_sniper_fleet", "WeaponName2", "rep_weap_inf_pistol")
	SetClassProperty("all_inf_sniper_fleet", "WeaponName3", "rep_weap_inf_thermaldetonator")
	SetClassProperty("all_inf_sniper_fleet", "WeaponName4", "rep_weap_inf_autoturret_dispenser")
	SetClassProperty("all_inf_sniper_fleet", "WeaponName5", "rep_weap_award_sniper_rifle")
	SetClassProperty("all_inf_sniper_fleet", "WeaponName6", "rep_weap_award_pistol")
	SetClassProperty("all_inf_sniper_fleet", "FoleyFXClass", "rep_inf_soldier")
	
	SetClassProperty("cis_hero_countdooku", "WeaponName2", "com_weap_inf_sabre_throw")
 end
...
function ScriptInit()
    ...
    SetupTeams{
	 ...
	 AddUnitClass(1, "jed_knight_01",1,2)
	 AddUnitClass(1, "jed_knight_02",0,2)
	 AddUnitClass(1, "jed_knight_03",0,2)
	 AddUnitClass(1, "jed_knight_04",1,2)
	 AddUnitClass(1, "jed_runner",0,2)
	 AddUnitClass(1, "jed_master_02",0,2)	

    --SetTeamName(CIS, "jedi")
	--SetTeamIcon(CIS, "all_icon")
...
--  Level Stats
 ...
 AddDeathRegion("DeathRegion1")
    ...
    SetLowReinforcementsVoiceOver(CIS, REP, "all_off_victory_im", .1, 1)    
