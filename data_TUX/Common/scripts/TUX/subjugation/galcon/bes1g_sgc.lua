...
DEF = 2
 ...
 function ScriptPostLoad()
 	--engineer
	SetClassProperty("all_inf_engineer_fleet", "GeometryName", "bes_inf_wingguard")
	SetClassProperty("all_inf_engineer_fleet", "GeometryLowRes", "bes_inf_wingguard_low1")
	--SetClassProperty("all_inf_engineer_fleet", "AnimationName", "besguard")
	--vanguard
	SetClassProperty("all_inf_rocketeer_jungle", "GeometryName", "bes_inf_wingguard")
	SetClassProperty("all_inf_rocketeer_jungle", "GeometryLowRes", "bes_inf_wingguard_low1")
	--SetClassProperty("all_inf_rocketeer_jungle", "AnimationName", "besguard")
	--sniper
	SetClassProperty("all_inf_sniper_fleet", "GeometryName", "bes_inf_wingguard")
	SetClassProperty("all_inf_sniper_fleet", "GeometryLowRes", "bes_inf_wingguard_low1")
	--SetClassProperty("all_inf_sniper_fleet", "AnimationName", "besguard")
