...
--	yTop = -70,
	...
	buttonlist = { 
		...
		--{ tag = "campaign", string = "ifs.sp.campaign", },
		{ tag = "minicamp", string = "ifs.sp.minicamp.title", },
...
--	this.buttons.custom.hidden = not bIsSplit
	...
	this.buttons.riseempire.bDimmed = 0
...
ifs_sp = NewIFShellScreen {
	...
	Input_Accept = function(this)
		...
		elseif (this.CurButton == "minicamp") then
			ScreenToPush = ifs_minicamp_campselect	
