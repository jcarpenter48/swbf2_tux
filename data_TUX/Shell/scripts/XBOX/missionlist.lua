...
--    { mapluafile = "TEST1%s",   era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1,},
	 { mapluafile = "bes1%s_%s",  era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_hunt_g = 1, mode_eli_g = 1, mode_sub_g = 1,},
     { mapluafile = "bes2%s_%s",  era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_ctf_c = 1, mode_ctf_g = 1, mode_eli_g = 1,},
    { mapluafile = "cor1%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_ctf_c = 1, mode_ctf_g = 1, mode_eli_g = 1, mode_ord66_c = 1, mode_hunt_c = 1, mode_sub_c = 1, mode_sub_g = 1, },
    { mapluafile = "dag1%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_ctf_c = 1, mode_ctf_g = 1, },
    { mapluafile = "dea1%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_1flag_c = 1, mode_1flag_g = 1, mode_hunt_g = 1,  },
    { mapluafile = "end1%s_%s", era_g = 1, era_c = 1,  mode_con_c = 1, mode_con_g = 1, mode_hunt_g = 1, mode_1flag_g = 1, mode_hunt_c = 1, mode_sub_g = 1, },
    { mapluafile = "fel1%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_1flag_c = 1, mode_1flag_g = 1, mode_hunt_c = 1, mode_ord66_c = 1, },
    { mapluafile = "geo1%s_%s", era_g = 1, era_c = 1, mode_con_g = 1, mode_con_c = 1, mode_ctf_c = 1, mode_hunt_c = 1, mode_hunt_g = 1, mode_sub_c = 1, },
	 { mapluafile = "geo2%s_%s",  era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_hunt_c = 1, mode_eli_g = 1,},
    { mapluafile = "hot1%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_1flag_g = 1, mode_hunt_g = 1, mode_hunt_c = 1,  },
    { mapluafile = "kam1%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_1flag_c = 1, mode_1flag_g = 1, mode_hunt_g = 1, mode_sub_g = 1, },
	 { mapluafile = "kam2%s_%s",  era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_hunt_g = 1, mode_eli_g = 1, mode_sub_g = 1,},	   	
    { mapluafile = "kas2%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_hunt_c = 1,  mode_ctf_c = 1, mode_ctf_g = 1, mode_eli_g = 1, mode_sub_c = 1, mode_sub_g = 1, mode_ord66_c = 1, },
	 { mapluafile = "kas1%s_%s",  era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_hunt_c = 1, mode_eli_g = 1, mode_sub_c = 1, mode_sub_g = 1, },
	 { mapluafile = "kas3%s_%s",  era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_hunt_c = 1, mode_eli_g = 1, mode_sub_c = 1, mode_sub_g = 1,},
	{ mapluafile = "mus1%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_ctf_c = 1, mode_ctf_g = 1, mode_hunt_c = 1, mode_hunt_g = 1, mode_sub_g = 1,},
    { mapluafile = "myg1%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_ctf_c = 1, mode_ctf_g = 1,  mode_eli_g = 1, mode_sub_g = 1, mode_ord66_c = 1, },
    { mapluafile = "nab2%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1,mode_ctf_c = 1, mode_ctf_g = 1, mode_hunt_c = 1,  mode_eli_g = 1, mode_hunt_g = 1, mode_sub_c = 1, mode_sub_g = 1,  },
	 { mapluafile = "nab1%s_%s",  era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_hunt_c = 1, mode_eli_g = 1,},  
	{ mapluafile = "pol1%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_ctf_c = 1, mode_ctf_g = 1, mode_hunt_c = 1,  },
     { mapluafile = "rhn1%s_%s",  era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_hunt_g = 1, mode_1flag_c = 1, mode_1flag_g = 1, mode_eli_g = 1,},
	 { mapluafile = "rhn2%s_%s",  era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_1flag_c = 1, mode_ctf_c = 1, mode_1flag_g = 1, mode_ctf_g = 1, mode_eli_g = 1, mode_sub_g = 1,},
...
--    { mapluafile = "spa2%s_%s",            era_c = 1, mode_con_c = 1, mode_con_g = 1, },
	...
	{ mapluafile = "sp5%s_%s",  era_g = 1, mode_assault_g = 1, mode_campaign_g = 1,},
    ...
    { mapluafile = "tat2%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_ctf_c = 1, mode_ctf_g = 1, mode_hunt_g = 1, mode_eli_g = 1, mode_sub_c = 1, mode_sub_g = 1, mode_obj_c = 1, },
    { mapluafile = "tat3%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_1flag_c = 1, mode_1flag_g = 1, mode_hunt_g = 1, mode_sub_c = 1, mode_sub_g = 1,},
	 { mapluafile = "tat1%s_%s",  era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_hunt_g = 1, mode_eli_g = 1, mode_sub_c = 1, mode_sub_g = 1,},
	{ mapluafile = "uta1%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_1flag_c = 1, mode_1flag_g = 1, mode_sub_g = 1, mode_ord66_c = 1, },
    { mapluafile = "yav1%s_%s", era_g = 1, era_c = 1, mode_con_c = 1, mode_con_g = 1, mode_1flag_c = 1, mode_1flag_g = 1,  },
	{ mapluafile = "yav2%s_%s",  era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_1flag_c = 1, mode_ctf_c = 1, mode_1flag_g = 1, mode_ctf_g = 1, mode_eli_g = 1,},
    { mapluafile = "kor1%s_%s", era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_ctf_c = 1, mode_ctf_g = 1, mode_hunt_c = 1,},
    { mapluafile = "sal1%s_%s", era_c = 1, era_g = 1, mode_con_c = 1, mode_con_g = 1, mode_ctf_c = 1, mode_ctf_g = 1, mode_eli_g = 1, mode_sub_g = 1,},
...
gMapModes = {
	...
	},
	{
		...
		--icon = "mode_icon_obj",
		icon = "mapselect_icon_random",
	},
	{
	   key = "mode_campaign", showstr = "modename.name.campaign", 
	   descstr = "modename.description.campaign", subst = "campaign", 
	   icon = "rote_icon",
	},
	{
	   key = "mode_sub", showstr = "modename.name.sub", 
	   descstr = "modename.description.sub", subst = "sub", 
	   icon = "mapselect_icon_launch",
	},
	{
	   key = "mode_ord66", showstr = "modename.name.ord66", 
	   descstr = "modename.description.ord66", subst = "ord66", 
	   icon = "mapselect_icon_sessionoptions",
	},
	{
