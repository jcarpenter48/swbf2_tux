...
--	yTop = -70,
	...
	buttonlist = { 
		...
		{ tag = "sgc",   string = "modename.name.sgc",   },
		--{ tag = "sub",   string = "modename.name.sgc",   },
	},
...
ifs_freeform_battle_mode = NewIFShellScreen {
	...
	buttons = NewIFContainer {
		...
		ScreenRelativeY = gDefaultButtonScreenRelativeY - 0.2, -- raised center to account for long list
	},
